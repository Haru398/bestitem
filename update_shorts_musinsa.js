...
const newItem = {
  id: 'item-shorts-1',
  title: '[1+1] 버닝몬스터 데일리 무지 밴딩 반바지 하프팬츠 (사이즈표 및 리얼착샷)',
  category: '패션/의류',
  content: content,
  ...
  additionalImages: [
    '/images/real_shorts_1.jpg',
    '/images/real_shorts_2.jpg',
    '/images/real_shorts_3.jpg',
    '/images/real_shorts_4.jpg',
    '/images/real_shorts_5.jpg'
  ],
...
console.log('Successfully updated data.json with 5 distinct model photos from Musinsa.');
