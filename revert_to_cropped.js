...
const newItem = {
  id: 'item-shorts-1',
  title: '[1+1] 버닝몬스터 데일리 무지 밴딩 반바지 하프팬츠 (사이즈표 및 모델착샷 포함)',
  category: '패션/의류',
  content: content,
  ...
  additionalImages: [
    '/images/real_shorts_1.png',
    '/images/real_shorts_2.png',
    '/images/real_shorts_3.png',
    '/images/real_shorts_4.png',
    '/images/real_shorts_5.png'
  ],
...
console.log('Successfully reverted to the cropped real shorts images.');
