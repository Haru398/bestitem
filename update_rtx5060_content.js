...
console.log('✅ RTX 5060 가이드 콘텐츠 업데이트 완료');
console.log('   - 이미지 제거 (쿠팡 CDN 핫링크 차단으로 인해)');
console.log('   - iframe 한 줄 형식으로 정돈');
console.log('   - 마크다운 테이블 3개 추가');
console.log('   - 번호 없는 리스트 형식 정돈');
db.close();
